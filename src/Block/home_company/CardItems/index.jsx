          ...
          <div style={styles.thirdPartyDetails}>
            <div style={styles.thirdPartyDetail}>
              ...
              <div style={styles.thirdPartyDetailItem}>
                <img
                  style={styles.thirdPartyDetailImg}
                  src="http://front_public.local.com/ice_project/reactphp/public/images/kMXuMYkLTCSkTnzoiRxs.png"
                  alt=""
                />
              ...
              <div style={styles.thirdPartyDetailItem}>
                <img
                  style={styles.thirdPartyDetailImg}
                  src="http://front_public.local.com/ice_project/reactphp/public/images/TpqeamkGvHuXSWKsLOth.png"
                  alt=""
                />
              ...
              >
                <img
                  style={styles.thirdPartyDetailImg}
                  src="http://front_public.local.com/ice_project/reactphp/public/images/ykkPpNnSjuqpqBhxjTir.png"
                  alt=""
                />
