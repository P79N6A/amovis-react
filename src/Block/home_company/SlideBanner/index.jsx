      ...
      <div className="hy-friends-list">
        ...
        >
          <img
            ...
            src="http://front_public.local.com/ice_project/reactphp/public/images/CdqiMTPofpGZyLcJkDHX.svg"
          />
          <h4>南都物业</h4>
          <span>适用场景：物业缴费</span>
          <p>
          ...
          <img
            ...
            src="http://front_public.local.com/ice_project/reactphp/public/images/MhShJeukuJNkenGytSiq.svg"
          />
        </a>
        ...
        >
          <img
            alt=""
            className="hy-friends-img"
            src="http://front_public.local.com/ice_project/reactphp/public/images/ZWoRmVSYImddLaRYyQog.jpg"
          />
          <h4>金地物业</h4>
          ...
          <img
            alt=""
            className="hy-friends-qr"
            src="http://front_public.local.com/ice_project/reactphp/public/images/cONkAwDeKdlzkcgchJLT.png"
          />
        </a>
        ...
        >
          <img
            alt=""
            className="hy-friends-img"
            src="http://front_public.local.com/ice_project/reactphp/public/images/MHiDpDgUNShsjTCQXKKd.jpg"
          />
          <h4>宋都阳光</h4>
          <span>适用场景：智能门禁</span>
          <p>
        ...
        >
          <img
            alt=""
            className="hy-friends-img"
            src="http://front_public.local.com/ice_project/reactphp/public/images/JQBQcVBtAiyTGINHQNzh.jpg"
          />
          <h4>融侨物业</h4>
