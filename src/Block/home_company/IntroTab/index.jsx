      ...
      <div className="scenario-column">
        ...
        <div className="scenario-slider ">
          <div className="scenario-list">
            ...
            >
              <img
                src="http://front_public.local.com/ice_project/reactphp/public/images/buKnoKlvQeEzYxttqrFh.svg"
                alt=""
              />
              <img
                className="selected"
                src="http://front_public.local.com/ice_project/reactphp/public/images/MnBlZZrbYBdVvXrCOyfW.svg"
                alt=""
              />
              <h4>物业缴费</h4>
              <p>提升缴费效率</p>
            ...
            >
              <img
                src="http://front_public.local.com/ice_project/reactphp/public/images/BdPVAfibJHPeFvZIcsTr.svg"
                alt=""
              />
              <img
                className="selected"
                src="http://front_public.local.com/ice_project/reactphp/public/images/NqHbRYuggzIiBJTZOCfa.svg"
                alt=""
              />
              <h4>小区生活号</h4>
              <p>物业运营阵地</p>
            ...
            >
              <img
                src="http://front_public.local.com/ice_project/reactphp/public/images/ZDqQbDUiGLDzygPQIMxp.svg"
                alt=""
              />
              <img
                className="selected"
                src="http://front_public.local.com/ice_project/reactphp/public/images/rHxglRXhjrhTOgRfqrah.svg"
                alt=""
              />
              <h4>社区理财</h4>
              <p>提升现金管理收益</p>
        ...
        <div className="scenario-detail-list bt1px">
          <div className={`scenario-detail-item ${this.isSelected(index, 0)}`}>
            ...
            <div className="scenario-detail-right">
              <img
                src="http://front_public.local.com/ice_project/reactphp/public/images/ATrmyVCFsdLJlliHBppp.png"
                alt=""
              />
            </div>
          </div>
          ...
          <div className={`scenario-detail-item ${this.isSelected(index, 1)}`}>
            ...
            <div className="scenario-detail-right">
              <img
                src="http://front_public.local.com/ice_project/reactphp/public/images/qhiRAOVMONMMircrVhJB.png"
                alt=""
              />
            </div>
          </div>
          ...
          <div className={`scenario-detail-item ${this.isSelected(index, 2)}`}>
            ...
            <div className="scenario-detail-right">
              <img
                src="http://front_public.local.com/ice_project/reactphp/public/images/ySkOyTnwEMufrSgxRSyq.png"
                alt=""
              />
            </div>
          </div>
